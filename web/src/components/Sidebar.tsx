...
export function Sidebar({
  ...
  return (
    <>
      ...
      <div
        className={`${pinned ? "sticky top-0 h-screen shrink-0" : "fixed inset-y-0 left-0 z-50"} glass-panel border-l-0 rounded-r-2xl shadow-[0_14px_36px_rgba(0,0,0,0.4)] w-[216px] px-4 pt-4 pb-5 flex flex-col gap-4 print-hide font-medium transition-transform duration-[240ms] ease-out overflow-y-auto ${
