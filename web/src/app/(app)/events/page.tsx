      ...
      <div className="hidden md:block">
        ...
        {events.map((event) => (
          <Link
            ...
            className="group grid grid-cols-[1.5fr_.9fr_.8fr_.8fr_.9fr_.6fr] gap-2.5 items-center py-3.5 px-3.5 rounded-xl border-b border-ink/8 last:border-b-0 text-[14px] hover:bg-ink/5"
          >
