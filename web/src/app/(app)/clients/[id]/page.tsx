      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_300px] gap-5 mt-5">
        <div>
          ...
          {client.contacts.map((contact) => (
            <div
              key={contact.id}
              className="hidden md:grid grid-cols-[1fr_1fr_1fr_1fr_auto] gap-2.5 items-center py-3.5 px-2.5 border-b border-ink/8 last:border-b-0 text-[14px]"
            >
          ...
          <div className="hidden md:block mt-1.5">
            {client.events.map((e) => (
              <Link
                key={e.id}
                href={`/events/${e.id}`}
                className="group grid grid-cols-[1.4fr_1fr_.8fr_.8fr] gap-2.5 items-center py-3.5 px-2.5 rounded-lg border-b border-ink/8 last:border-b-0 text-[14px] hover:bg-ink/5"
              >
