...
INSERT INTO "new_CompanySettings" ("accentColor", "address", "bankAccount", "bgColor", "defaultDueDays", "dic", "ico", "id", "inkColor", "invoiceEmailBody", "invoiceEmailSubject", "isVatPayer", "locale", "logoPath", "name", "positiveColor", "reminderEmailBody", "reminderEmailSubject", "surfaceColor", "warningColor") SELECT "accentColor", "address", "bankAccount", "bgColor", "defaultDueDays", "dic", "ico", "id", "inkColor", "invoiceEmailBody", "invoiceEmailSubject", "isVatPayer", "locale", "logoPath", "name", "positiveColor", "reminderEmailBody", "reminderEmailSubject", "surfaceColor", "warningColor" FROM "CompanySettings";
