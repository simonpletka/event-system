...
INSERT INTO "new_TimeEntry" ("date", "description", "endedAt", "eventId", "id", "minutes", "phase", "running", "startedAt", "userId") SELECT "date", "description", "endedAt", "eventId", "id", "minutes", "phase", "running", "startedAt", "userId" FROM "TimeEntry";
